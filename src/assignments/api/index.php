...
if (!validateDate($due_date)) {
        sendResponse(['success' => false, 'message' => 'Invalid date format (YYYY-MM-DD)'], 400);
    }
...
$params[] = $data['id']; // For the WHERE clause
...
error_log("Database Error: " . $e->getMessage());
    sendResponse(['success' => false, 'message' => 'Internal Server Database Error'], 500);
